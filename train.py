...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'logs/3700000000002_104817_1/ep050-loss1.326-val_loss1.249.pth'
    #------------------------------------------------------#
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = train_filename+'_train.txt'
    val_annotation_path     = train_filename+'_valid.txt'
    ...
    if True:
        ...
        for epoch in range(start_epoch, end_epoch):
            fit_one_epoch(model_train, model, yolo_loss, loss_history, optimizer, epoch, 
                    epoch_step, epoch_step_val, gen, gen_val, end_epoch, Cuda, train_filename)
            lr_scheduler.step()
